        ...
        <>
            ...
            <div className=" hidden  md:flex  justify-between items-center px-10 py-5 sticky top-0 bg-white shadow-lg z-50">
                ...
                <ul className="flex   gap-6">
                    <Link
                        to={"/"}
                        className={`text-[#757575]  group py-2  duration-500 relative transition-all text-[0.95rem] ${(pathname == "/" || pathname == "") && "!font-bold !text-black"
                            }  font-medium w-full hover:font-bold hover:text-black`}

                    >
                        Home
                        <div
                            className={`w-0 group-hover:w-full  ${(pathname == "/" || pathname == "") && "w-full"
                                } absolute bottom-0 h-1 rounded-md duration-500 bg-gradient-to-r from-[#00EA87] to-[#78CBFF] `}
                        ></div>
                    </Link>
                    <Link
                        to={"/about-us"}
                        className={`text-[#757575] duration-500 group py-2 relative transition-all w-full text-[0.95rem] ${pathname == "/about-us" && "!font-bold !text-black "
                            }  font-semibold hover:font-bold hover:text-black`}
                    >
                        About
                        <div
                            className={`w-0 group-hover:w-full ${pathname == "/about-us" && "w-full"
                                } absolute bottom-0 h-1 rounded-md duration-500 bg-gradient-to-r from-[#00EA87] to-[#78CBFF] `}
                        ></div>
                    </Link>
                    <Link
                        to={"/product"}
                        className={`text-[#757575] duration-500 group py-2 ${pathname == "/product" && "!font-bold !text-black"
                            } relative transition-all w-full text-[0.95rem] font-semibold hover:font-bold hover:text-black`}
                    >
                        Product
                        <div
                            className={`w-0 group-hover:w-full absolute bottom-0 h-1 ${pathname == "/product" && "w-full"
                                } rounded-md duration-500 bg-gradient-to-r from-[#00EA87] to-[#78CBFF] `}
                        ></div>
                    </Link>
                    <Link
                        to={"/team"}
                        className={`text-[#757575] relative duration-500 ${pathname == "/team" && "!font-bold !text-black"
                            } group py-2 transition-all w-full text-[0.95rem]  font-semibold hover:font-bold hover:text-black`}
                    >
                        Team
                        <div
                            className={`w-0 group-hover:w-full ${pathname == "/team" && "w-full"
                                } absolute bottom-0 h-1 rounded-md duration-500 bg-gradient-to-r from-[#00EA87] to-[#78CBFF] `}
                        ></div>
                    </Link>
                    <Link
                        to={"/contact-us"}
                        className={`text-[#757575] relative duration-500 py-2 group ${pathname == "/contact-us" && "!font-bold !text-black"
                            } transition-all w-full text-[0.95rem]  font-semibold hover:font-bold hover:text-black`}
                    >
                        Contact
                        <div
                            className={`w-0 group-hover:w-full ${pathname == "/contact-us" && "w-full"
                                } absolute bottom-0 h-1 rounded-md duration-500 bg-gradient-to-r from-[#00EA87] to-[#78CBFF] `}
                        ></div>
                    </Link>
                </ul>
